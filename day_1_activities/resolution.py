...
#             # if found, return the dictionary
#             return student #return you will give data back to use later , print is displaying
#     # if not found, return None
#     return None
...
# # -----------------------------------------
# while True: #this is usally the last part of the program
#     # Menu
#     print("\n===== STUDENT LOOKUP TOOL =====")
